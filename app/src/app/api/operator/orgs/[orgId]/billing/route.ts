...
async function notifyPlanChange(args: {
  ...
  const html = `
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-family:-apple-system,BlinkMacSystemFont,sans-serif;line-height:1.5;color:#34263F;background:#FBF8F2;">
      <tr><td style="padding:24px;">
        ...
        <p style="margin:0 0 12px;color:#34263F;">Status: <strong>${escapeHtml(args.status.toLowerCase())}</strong>.</p>
        <p style="margin:0 0 16px;color:#34263F;">${escapeHtml(perks)}</p>
